...
Convertor for translating HTML into TML (TWiki Markup Language)
...
sub convert {
    ...
    # $text is octets, encoded as per the $TWiki::cfg{Site}{CharSet}
...
sub _default {
    ...
    #
    # TWiki:Main.PaulHarvey triggered this assert with some crusty
